...
//        BarChart chart = getActivity().findViewById(R.id.barChart);

//        ArrayList<BarEntry>dataVals = new ArrayList<BarEntry>();
//
//        dataVals.add(new BarEntry(0, new float[]{38, 25, 42, 86}));
//        dataVals.add(new BarEntry(1, new float[]{42, 15, 34, 76}));
//        dataVals.add(new BarEntry(2, new float[]{41, 25, 46, 86}));
//        dataVals.add(new BarEntry(3, new float[]{42, 15, 24, 66}));
//        dataVals.add(new BarEntry(4, new float[]{30, 15, 24, 96}));
//        dataVals.add(new BarEntry(5, new float[]{35, 25, 64, 76}));
//        dataVals.add(new BarEntry(6, new float[]{38, 15, 44, 68}));
